...
const PLUGIN_CATALOG = [
  ...
  },
  {
    ...
    name: "Wikist 高级搜索",
    type: "search-engine",
    source: "Wikist Core / MiniSearch-style field index",
    repository: "https://github.com/lucaong/minisearch",
    vendorDirectory: "minisearch",
    description: "轻量高级搜索插件层，支持分页、字段权重、前缀匹配、模糊匹配、分类/质量/难度过滤，接口参考 MiniSearch 的浏览器友好搜索思路。",
    syntax: [
      "title:群 category:代数",
      "\"Lagrange theorem\" quality:A",
      "difficulty:本科 群论",
    ],
    configKeys: ["enabled", "engine", "fuzzy", "prefix", "pageSize", "titleWeight", "summaryWeight", "bodyWeight", "categoryWeight"],
    defaultConfig: {
      enabled: true,
      engine: "wikist-mini",
      fuzzy: true,
